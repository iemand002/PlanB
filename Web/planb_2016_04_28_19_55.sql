...
--
-- Machine: localhost
-- Genereertijd: 28 apr 2016 om 19:54
...
INSERT INTO `projecten` (`id`, `naam`, `beschrijving`, `publish_till`, `publish_from`, `slug`, `created_at`, `updated_at`, `thema_id`) VALUES
(1, 'Ringland', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque dolorem illo, incidunt inventore ipsum\n            minus nesciunt numquam, perferendis perspiciatis quis veniam voluptate voluptates voluptatum! Alias eveniet\n            id illo nobis qui.', '2016-05-28 19:53:36', '2016-04-28 19:53:36', 'ringland', '2016-04-28 17:53:36', '2016-04-28 17:53:36', 3),
(2, 'Bomen op de Groenplaats', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque dolorem illo, incidunt inventore ipsum\n            minus nesciunt numquam, perferendis perspiciatis quis veniam voluptate voluptates voluptatum! Alias eveniet\n            id illo nobis qui.', '2016-05-28 19:53:36', '2016-04-28 19:53:36', 'bomen-op-de-groenplaats', '2016-04-28 17:53:36', '2016-04-28 17:53:36', 2);
...
ALTER TABLE `gevolgde_projecten`
  ...
  ADD CONSTRAINT `gevolgde_projecten_gebruiker_id_foreign` FOREIGN KEY (`gebruiker_id`) REFERENCES `gebruikers` (`id`) ON UPDATE CASCADE;
